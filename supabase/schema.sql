...
-- Public leaderboard access (read-only, with username)
CREATE POLICY "Public can view completed sessions for leaderboard" 
ON learning_sessions FOR SELECT 
TO anon, authenticated
USING (ended_at IS NOT NULL);

-- Create leaderboard view with display names from auth
